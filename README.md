<div align="center">
  ...
  [![Version](https://img.shields.io/badge/version-12.6.0-blue.svg)](https://github.com/chenx-dust/moonlight-vminus/releases/tag/shortcut)
...
1. 从 [Releases](https://github.com/chenx-dust/moonlight-android/releases) 页面下载最新版本
2. 安装 APK 文件
3. 按照应用内指引完成设置
